...
红骨科技，是成都华栖云科技有限公司（阿里巴巴集团与成都索贝数码科技股份有限公司合资成立）的核心业务部门之一，承担着面向教育行业进行媒体混合云服务的业务拓展，提供云端教学、实训、直播等云服务的核心任务，通过在线课程、技能培训、专业认证、教育直播、云端实验室、企业实训、云校园综合解决方案等多种产品，为教育机构和从业人员，提供无处不在、随时可用的专业云服务。
			</p>
		</div>
	</div>
</div>
	...
	<div class="inner">
		...
		<ul class="zyyw-ul clearfix">
			...
			<li>
				...
				<h4>在线课程</h4>
				<p>依托红骨科技持续不断积累的视音频课程内容，为学校、企业、个人用户，提供多种个性化的在线学习内容和服务平台</p>
			</li>
			<li>
...
<div style="height: 335px;background: url(<?=Url::to('@web/mlv/img/temp/intro-banner2.jpg', true)?>) no-repeat top center;">
	<div class="inner">
		...
		<p class="f14 text-center" style="line-height: 24px;color:#d9dfeb;">红骨科技致力于培训未来的传媒精英人才，通过媒体校园实验室系统建设及互联网化云校园建设，让学生在校期间，就能体验媒体单位<br>

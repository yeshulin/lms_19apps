					...
					success:function(_html){			
						...
						$.post(urlPre + "/api/live/roomshow",data,function(data){
							...
							if(!!data.data){
								...
								"room_notice" : data.data.room_notice?data.data.room_notice:"红骨科技，是成都华栖云科技有限公司的核心业务，承担着面向教育行业进行媒体混合云服务的业务拓展，提供云端教学、实训、直播等云服务的核心任务，通过在线课程、技能培训、专业认证、教育直播、云端实验室、企业实训、云校园综合解决方案等多种产品，为教育机构和从业人员，提供无处不在、随时可用的专业云服务",
								...
								"ownerName" : "暂无作者",
								"videourl":"null",
								"room_notice":"红骨科技，是成都华栖云科技有限公司的核心业务，承担着面向教育行业进行媒体混合云服务的业务拓展，提供云端教学、实训、直播等云服务的核心任务，通过在线课程、技能培训、专业认证、教育直播、云端实验室、企业实训、云校园综合解决方案等多种产品，为教育机构和从业人员，提供无处不在、随时可用的专业云服务",
								"head_img" : "暂无头像"	,
								"iframeSrc" : _iframe_src,
								"hasData": false					
								}];

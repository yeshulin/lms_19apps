...
<!--				<img class="r" height="102" width="102" src="--><?//=Url::to('@web/mlv/img/temp/ewm.png', true)?><!--" alt="">-->
				<div class="r text-right" style="margin-right: 10px;">
					<p style="color: #e76f45;">扫一扫，关注红骨科技官方订阅号</p>
			...
			<div style="border-top: 1px dashed #404452;height: 53px;line-height: 53px;color: #4c505e;">
				<p class="text-center f14"><span class="f16" style="color:#697088;">红骨科技</span>&nbsp;<span style="font-size:14px;color:#697088;">Copyright  2016, www.lms.19apps.com, All Rights Reserved </span>  </p>
			</div>
		</div>

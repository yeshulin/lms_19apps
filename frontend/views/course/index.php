...
<!--			<dl>-->
<!--				<dt><a target="_blank" href="#"><img src="--><?//=Url::to('@web/mlv/img/temp/asd8972143912.png', true)?><!--" alt=""></a></dt>-->
<!--				<dd><a target="_blank" href="#">课程促销活动</a></dd>-->
<!--			</dl>-->
<!--			<dl>-->
<!--				<dt><a target="_blank" href="#"><img src="--><?//=Url::to('@web/mlv/img/temp/asd8972143912.png', true)?><!--" alt=""></a></dt>-->
<!--				<dd><a target="_blank" href="#">课程促销活动</a></dd>-->
...
<!---->
<!--		<div class="cause-style3">-->
<!--			<h3><a target="_blank" class="r" href="--><?//=Url::to("/site/course/list")?><!--">更多&gt;</a><span>实践</span><a target="_blank" href="#">AE粒子运动</a><a target="_blank" href="#">AE粒子运动</a><a target="_blank" href="#">AE粒子运动</a></h3>-->
<!--			<div class="clearfix course-list-index" key="1,2" style="margin-left: -20px;margin-top: 12px;">-->
<!---->
<!--			</div>-->
<!--		</div>-->
<!--		<div class="cause-style3">-->
<!--			<h3><a target="_blank" class="r" href="--><?//=Url::to("/site/course/list")?><!--">更多&gt;</a><span>实践</span><a target="_blank" href="#">AE粒子运动</a><a target="_blank" href="#">AE粒子运动</a><a target="_blank" href="#">AE粒子运动</a></h3>-->
<!--			<div class="clearfix course-list-index" key="1,6" style="margin-left: -20px;margin-top: 12px;">-->
<!---->
<!--			</div>-->
<!--		</div>-->
<!--	</div>-->

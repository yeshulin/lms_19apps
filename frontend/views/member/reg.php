        ...
        <div class="am-tabs-bd" style="margin-top: 59px;">
            <div data-tab-panel-0 class="am-tab-panel am-active">
                <div style="visibility: visible;">
                    ...
                    <div class="am-g" style="margin-top: 37px;">
                        <div class="am-u-sm-7 am-u-sm-offset-3 "> <span class="left3"></span> <input type="text" id="r-top_userid" placeholder="请输入代理商码" value="<?=$uid?>" class="am-form-field clearChromeRemeber" style="margin: auto;display: block;float: left;padding-left: 55px;width: 528px;" /> </div>
                    </div>
